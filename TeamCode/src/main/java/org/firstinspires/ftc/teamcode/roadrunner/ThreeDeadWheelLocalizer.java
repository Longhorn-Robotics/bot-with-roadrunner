...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -3819.5734954910768; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = -8095.500673264698; // y position of the second parallel encoder (in tick units)
